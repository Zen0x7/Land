...
Each connection tracks sidecar metrics: status, last latency, average latency, sample count, read/write totals (bytes/KB/MB), and read/write rates per second. Sampling is aligned at the beginning of each second.
